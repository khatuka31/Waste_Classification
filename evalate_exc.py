...
#Exercise 5.2: Determine if the model is overfitting to the training data by comparing performance between training and evaluation data use model.evaluate()
...
#Exercise 5.4: Evaluate performance on the test dataset

#6. Hyperparameter tuning and regularization
#Exercise 6.1: Adjust the batch size (reduce to 1, increase to 100), retrain, and evaluate performance

#Exercise 6.2: Add dropout to model training and evaluate performance
